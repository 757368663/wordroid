                 ...
                 lv.setOnItemClickListener(new OnItemClickListener(){
  			     ...
  			     public void onItemClick(AdapterView<?> arg0, View v, int position,
                    ...
                    public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
     					...
     					// TODO Auto-generated method stub
//                        Dialog dialog = new Dialog(study.this);
     					AlertDialog.Builder dialog = new AlertDialog.Builder(study.this,R.style.AlertDialog);
     		            dialog.setIcon(R.drawable.dialog_icon);
     		            dialog.setTitle("操作");
     		            dialog.setItems(new String[]{"标记为已学习"}, new DialogInterface.OnClickListener(){
...
//                        dialog.setView(R.layout.dialog_xml);
     					dialog.show();
//                        Drawable drawable = ContextCompat.getDrawable(study.this,R.drawable.dialog);
//                        dialog.getWindow().setBackgroundDrawable(drawable);
 	...
 	private void startStudy(final int arg2,final int tag,final int check) {
 		if(tag==2){
 			if(check==1){
 		 		Dialog dialog = new AlertDialog.Builder(study.this,R.style.AlertDialog)
 				...
 				dialog.show();
				dialog.getWindow().setBackgroundDrawable(ContextCompat.getDrawable(study.this,R.drawable.white_btn));
 			}
 			else{
 		AlertDialog dialog = new AlertDialog.Builder(study.this)
//                .setView(R.layout.dialog_xml)
//                .create();
        ...
        .setNeutralButton("取消", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
				...
				dialog.getWindow().setBackgroundDrawable(ContextCompat.getDrawable(study.this,R.drawable.white_btn));
		dialog.show();
//		dialog.getWindow().setBackgroundDrawable(ContextCompat.getDrawable(study.this,R.drawable.dialog));
